...
/// <summary>
/// Mirror of <see cref="USsTestGenFunctionManual"/> whose subclassing UFunction bindings are
/// produced by the SharpScript source generator (SharpScriptSourceGenerator) rather than being
/// hand-written. Each [UFUNCTION] echoes its input to the out parameter and the return value so
...
public partial class USsTestGenFunctionSourceGenerator : UObject
{
	...
	[UFUNCTION]
	public ESsTestGenEnumSourceGenerator FuncEnum(ESsTestGenEnumSourceGenerator InValue, out ESsTestGenEnumSourceGenerator OutValue)
	{
		OutValue = InValue;
		return OutValue;
	}
