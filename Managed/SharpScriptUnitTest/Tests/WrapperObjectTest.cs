...
/// <summary>
/// Test properties and methods statically exported from UObject.
/// </summary>
[RecordFilePath]
public class WrapperObjectTest : IUnitTestInterface
{
	public bool RunTest()
	{
		...
		obj.Enum = ESsTestEnum.Two;
		Utils.Assert(obj.Enum == ESsTestEnum.Two);
		obj.LongEnum = ESsTestLongEnum.Two;
		Utils.Assert(obj.LongEnum == ESsTestLongEnum.Two);
		obj.String = "String";
		...
		Utils.Assert(obj.FuncBlueprintImplementable(2) == 0);
		Utils.Assert(obj.FuncBlueprintNative(2) == 2);
		obj.FuncBlueprintNativeRef(ref testStruct);
