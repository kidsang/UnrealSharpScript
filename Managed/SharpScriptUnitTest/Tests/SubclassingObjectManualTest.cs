...
public class SubclassingObjectManualTest : IUnitTestInterface
{
	public bool RunTest()
	{
		...
		Utils.Assert(obj.Enum == ESsTestGenEnumManual.One);
		...
		obj.Enum = ESsTestGenEnumManual.Two;
		Utils.Assert(obj.Enum == ESsTestGenEnumManual.Two);
		obj.String = "String";
		...
		Utils.Assert(obj.Struct.Enum == ESsTestGenEnumManual.One);
		...
		Utils.Assert(obj.StructArray[0].Enum == ESsTestGenEnumManual.One);
	...
	private static void TestObjectAsContainerValue(USsTestGenClassManual obj, USsTestGenClassManual objValue)
	{
		USsTestGenClassManual objOne = NewObject<USsTestGenClassManual>();
		USsTestGenClassManual objTwo = NewObject<USsTestGenClassManual>();
